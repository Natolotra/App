<%@ Page Title="" Language="C#" MasterPageFile="~/ihmActeur/controleur/MasterControleur.Master" AutoEventWireup="true" CodeBehind="PlanningCalendarJourAD.aspx.cs" Inherits="AppWeb.ihmActeur.controleur.PlanningCalendarJourAD" %>
                ...
                <div>
                    ...
                    <div>
                        <DayPilot:DayPilotCalendar ID="Calendar" runat="server"
                            ...
                            ColumnBubbleID="BubbleFicheBord" 
                            onbeforeeventrender="Calendar_BeforeEventRender" 
                            oneventmove="Calendar_EventMove" 
                            Width="100%" EventMoveHandling="PostBack" BusinessEndsHour="20">
