<%@ Page Title="" Language="C#" MasterPageFile="~/ihmActeur/controleur/MasterControleur.Master" AutoEventWireup="true" CodeBehind="AutorisationDeVoyage.aspx.cs" Inherits="AppWeb.ihmActeur.controleur.AutorisationDeVoyage" %>
                ...
                <div id="OneLayoteLeft">
                    <div class="formContent">
                        ...
                        <div class="formulaire">
                            Remplir la formulaire par la liste <b class="important">autorisations de voyage</b> en dessou de la formulaire.
                        </div>
                    </div>
                </div>
                        ...
                        <div class="contentFormulaires">
                            <div class="formulaire">
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="6">&nbsp;
                                             <asp:RequiredFieldValidator ID="TextNomAgentTechnique_RequiredFieldValidator" runat="server" ErrorMessage=""
                                              ControlToValidate="TextNomAgentTechnique" ValidationGroup="groupeFB">*
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextDateDepart" runat="server">
                                            </asp:TextBox>
                                            <asp:RequiredFieldValidator ID="TextDateDepart_RequiredFieldValidator" runat="server" ErrorMessage=""
                                            ControlToValidate="TextDateDepart" ValidationGroup="groupeFB">*
                                            </asp:RequiredFieldValidator>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlHeure" runat="server" SkinID="ddlStandard">
                                            ...
                                            :
                                            <asp:DropDownList ID="ddlMinute" runat="server" SkinID="ddlStandard">
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            ...
                                            <asp:ValidationSummary ID="ValidationSummary_FB" runat="server" ValidationGroup="groupeFB"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
                                            <asp:Button ID="btnAnnuler" runat="server" Text="Nouveau" SkinID="btnValidation"
                                                onclick="btnAnnuler_Click" />
                                            <asp:Button ID="btnValide" runat="server" Text="Etablir une fiche de bord" 
                                                onclick="btnValide_Click" ValidationGroup="groupeFB" SkinID="btnValidation"/>
