...
namespace AppWeb.ihmActeur.planificateur
{
    public partial class AutorisationDeVoyage : System.Web.UI.Page
    {
        ...
        private void loadDDLTriAutorisation()
        {
            ...
            ddlTriAutorisation.Items.Add(new ListItem("Vehicule", "numImmatricule"));
            ...
            ddlTriAutorisation.Items.Add(new ListItem("Itineraire ville", "villeItineraireDebut"));
            ddlTriAutorisation.Items.Add(new ListItem("Itineraire ville", "villeItineraireFin"));
