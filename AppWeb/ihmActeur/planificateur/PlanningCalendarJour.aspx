<%@ Page Title="" Language="C#" MasterPageFile="~/ihmActeur/planificateur/MasterPlanificateur.Master" AutoEventWireup="true" CodeBehind="PlanningCalendarJour.aspx.cs" Inherits="AppWeb.ihmActeur.planificateur.PlanningCalendarJour" %>
                ...
                <div>
                    ...
                    <div>
                        <DayPilot:DayPilotCalendar ID="Calendar" runat="server"
                            ...
                            ColumnBubbleID="BubbleFicheBord" DataServerTagFields="color" onbeforeeventrender="Calendar_BeforeEventRender" 
                            Width="100%" 
